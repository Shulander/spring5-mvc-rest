...
public class VendorController {
    ...
    @PostMapping
    @ApiOperation(value = "Create a new vendor", consumes = APPLICATION_JSON_VALUE)
    ...
    @ResponseStatus(HttpStatus.OK)
    @PutMapping(value = "/{id}")
    @ApiOperation(value = "Update a vendor identified by id",
    ...
    @ApiOperation(value = "Partial update a vendor identified by id",
            consumes = APPLICATION_JSON_VALUE)
